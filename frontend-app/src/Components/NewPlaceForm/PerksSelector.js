...
const PerksSelector = ({ perks, selectedPerks, setSelectedPerks }) => {
  const perkIcon = (perk) => {
    switch (perk) {
      case "wifi":
        return (
  ...
  return (
    <div className="mt-4 w-full gap-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      {perks.map((perk, index) => (
        <div key={index}>
          <label className="flex gap-4 border p-4 rounded-2xl justify-center w-full cursor-pointer">
            <input
              type="checkbox"
